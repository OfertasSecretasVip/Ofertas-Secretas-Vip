  ...
  return (
    <div className="min-h-screen bg-[#fff8fa] px-3 py-4 font-sans text-slate-900 antialiased sm:py-6">
      <main className="mx-auto flex w-full max-w-[410px] flex-col items-center">
        <div
          className={`mb-3 flex min-h-10 items-center gap-2 rounded-full border border-emerald-100 bg-white px-4 py-2 shadow-sm transition-all duration-500 ${
        ...
        <section className="w-full overflow-hidden rounded-[26px] border border-rose-100 bg-white px-5 pb-6 pt-5 text-center shadow-[0_14px_40px_rgba(190,24,93,0.07)] sm:px-6">
          <div className="mb-3 inline-flex items-center rounded-full bg-rose-50 px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-wide text-rose-600">
            Grupo gratuito no WhatsApp
          </div>

          <div className="relative mx-auto mb-3.5 h-[118px] w-[118px] overflow-hidden rounded-full border-[3px] border-white bg-white shadow-[0_4px_16px_rgba(15,23,42,0.13)]">
            <Image
          ...
          <p className="mb-1 text-[12px] font-bold uppercase tracking-[0.12em] text-rose-500">Ofertas Secretas VIP</p>
          <h1 className="text-balance text-[1.9rem] font-extrabold leading-[1.05] tracking-tight text-slate-900 sm:text-[1.9rem]">
            Grupo de Ofertas no WhatsApp
          </h1>

          <p className="mx-auto mt-3 max-w-[340px] text-[14px] leading-[1.5] text-slate-600">
            Ofertas, cupons e achadinhos selecionados todos os dias direto no seu WhatsApp.
          </p>

          <div className="mx-auto mt-4 flex flex-wrap items-center justify-center gap-x-4 gap-y-1.5 text-[12px] font-semibold text-slate-700">
          ...
          <a
            ...
            className="mt-4.5 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#25D366] px-4 py-4 text-[15px] font-extrabold text-white shadow-[0_9px_22px_rgba(37,211,102,0.22)] transition-transform duration-150 hover:brightness-95 active:scale-[0.98]"
          >
          ...
          <p className="mt-2.5 text-[11px] text-slate-400">É grátis. Entre e acompanhe as ofertas quando quiser.</p>
        </section>

        <footer className="mt-3 text-center text-[11px] text-slate-400">© 2026 Ofertas Secretas VIP</footer>
      </main>
    </div>
  )
}
